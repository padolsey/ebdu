...
import { SearchResult, SearchResultError, SearchResultSuccess, EmbeddingResult } from '../types';

class EmbeddingsService {
  documentService = documentService;
  private embeddingPromises: Map<string, Promise<void>> = new Map();

  async handleSearch(documentUrls: string[], tokens: number, n: number, query: string) {
  ...
  async handleSearch1(documentUrls: string[], tokens: number, n: number, query: string) {
  ...
  async createEmbeddings(documentUrls: string[], documentsHash: string) {
  ...
  async searchEmbeddings(embeddings: EmbeddingResult[], query: string, n: number, tokens: number) {
