...
describe('EmbeddingsService', () => {
  ...
  test('should return "embedding" progress when embeddings are not yet available', async () => {
    ...
    const result: SearchResult = await embeddingsService.handleSearch(documentUrls, tokens, n, query);
  ...
  test('should eventually return "finished_embedding" after embeddings are created', async () => {
    ...
    const initialResult: SearchResult = await embeddingsService.handleSearch(documentUrls, tokens, n, query);
    ...
    const finalResult: SearchResult = await embeddingsService.handleSearch(documentUrls, tokens, n, query);
